...
INSERT INTO employees (emp_id, emp_name, gender, age, hire_date, designation, department_id, location_id, salary) VALUES
...
SELECT department_id, COUNT(*) AS total_employees FROM employees GROUP BY department_id HAVING COUNT(*) < 3;
